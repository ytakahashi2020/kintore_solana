...
pub struct UpdateBalance<'info> {
    ...
    pub bank_account: /* ④BankAccountのアカウント */,

    pub system_program: /* ⑤システムプログラム */,
}
...
pub struct AddInterest<'info> {
    ...
    pub thread: /* 11Threadのアカウント */,

    #[account(
        /* 12THREAD_AUTHORITY_SEEDのシード */
        /* 13bump */
    )]
    pub thread_authority: /* 13システムアカウント */,
}
