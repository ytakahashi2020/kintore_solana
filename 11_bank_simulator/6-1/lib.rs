...
use anchor_lang::/* ①Solana Programのインストラクション */;
use anchor_lang::/* ②インストラクションデータ */;
use /* ③clockSDK */::{Thread, ThreadAccount};
...
const CRON_SCHEDULE: /* ④型 */ = "*/10 * * * * * *"; // 10s https://crontab.guru/
const AUTOMATION_FEE: u64 = 5000000; // https://docs.clockwork.xyz/developers/threads/fees

pub const BANK_ACCOUNT_SEED: /* ⑤型 */ = b"bank_account";
pub const THREAD_AUTHORITY_SEED: /* ⑥型 */ = b"authority";
...
pub mod bank_simulator {
    ...
    pub fn initialize_account(
        ...
        let clockwork_program = /* ⑧clockwork_program */;

        let holder = /* ⑨holder */;
        let bank_account = /* 10変更可能 *//* 11bank_account */;

        let thread = /* 12thread */;
        let thread_authority = /* 13thread_authority */;
